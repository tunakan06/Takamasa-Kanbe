...
// 書き込み用にバイナリファイルを開く
bool BinaryFile::WriteBinFile_Open(
	...
	error = fopen_s(&fp, FilePathS, "wb");
	BinFileData->FilePointer = fp;
...
void BinaryFile::WriteBinFile_Close(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData
){
...
void BinaryFile::WriteBinFile_Data(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_Int(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_Bool(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_Float(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_Vector(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_String(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_UChar(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_UInt(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::WriteBinFile_ColorU8(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
// 読み込み用にバイナリファイルを開く
bool BinaryFile::ReadBinFile_Open(		
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
void BinaryFile::ReadBinFile_Close(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData
)
{
...
bool BinaryFile::ReadBinFile_Data(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_Int(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_Bool(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_Float(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_Vector(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_String(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_UChar(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_UInt(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
...
bool BinaryFile::ReadBinFile_ColorU8(
	// バイナリファイルアクセス用情報構造体のアドレス
	SBinaryFileData *BinFileData,
